export class PlayerData {
    constructor(public homePlayerName: string, public homeIncomingPlayerName: string, public homePlayerPosition: string, public homePlayerPoints: number, public homeIncomingPlayerPoints: number, public homePlayerPointDiff: number, public homePlayerLastUpdate: string, 
